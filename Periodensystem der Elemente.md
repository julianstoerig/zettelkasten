...
Das **PSE** ist in 7 *Perioden* von Oben nach unten eingeteilt., dabei steht jede Periode von oben für die Füllung eben jener Schale in der [[📂Zettelstapel/Mikrobiologie/Elektronenkonfiguration]] der [[chemisches Element|Elemente]] der Periode (Bsp.: $\ce{Be}$ ist in der 2. Periode, bei $\ce{Be}$ wird also die 2. Schale gefüllt). 
...
An der Struktur des **PSE** lässt sich auch erkennen, bei der [[📂Zettelstapel/Mikrobiologie/Elektronenkonfiguration]] welcher [[chemisches Element|Elemente]], welche [[📂Zettelstapel/Mikrobiologie/Orbitale]] zur Ionisierung gefüllt bzw. geleert werden müssen:
